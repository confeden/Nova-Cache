...
impl eframe::App for NovaCacheApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::left("config_panel").frame(egui::Frame::NONE.inner_margin(egui::Margin::symmetric(12, 8))).resizable(false).default_width(300.0).show(ctx, |ui| {
            ui.add_space(10.0);
